...
public class DriverSetting extends AppCompatActivity {
    ...
    private EditText mName, mPhone,mCarPlate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCarPlate =(EditText) findViewById(R.id.car_plate);
        ...
        mDriverDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()&&dataSnapshot.getChildrenCount()>0){
                    ...
                    if(map.get("car")!= null){
                        car_info = map.get("car").toString();
                        mCarPlate.setText(car_info);
    ...
    private void saveUserInformation(){
        ...
        car_info = mCarPlate.getText().toString();
        Map userInfo = new HashMap();
        userInfo.put("name",name_info);
        userInfo.put("phone",phone_info);
        userInfo.put("car",car_info);
